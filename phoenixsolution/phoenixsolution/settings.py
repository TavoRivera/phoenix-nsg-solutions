"""
Django settings for phoenixsolution project.
...
STATIC_URL = "static/"
MEDIA_URL = '/media/'  # URL accesible en el navegador
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Ruta donde se almacenan en el servidor
